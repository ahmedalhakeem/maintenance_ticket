    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memorandum_statue', models.CharField(choices=[('memo_received', 'memo received'), ('memo_not_received', 'memo_not_received'), ('wrong_memo', 'wrong_memo')], default=False, max_length=20)),
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cars', to='eticket.cars')),
