...
class User(AbstractUser):
   department = models.ForeignKey(Department, on_delete=models.CASCADE, related_name="dept_name", null=True, blank=True)
   section = models.ForeignKey(Section, on_delete=models.CASCADE, related_name="sect_name", null=True, blank=True)
...
class Drivers(models.Model):
   ...
   def __str__(self):
      return f" {self.id},{self.driver_name}"
